...
client.on('ready', async () => {
    client.user.setPresence({ activity: { name: "🖤 Vain" }, status: "idle" });
});

//----------------------------------------------------------------------------------------------------------------------------------------
///BU ALTYAPI VAİN'E AİTTİR
///DİSCORD İSMİM Vain.#7864 
...
Date.prototype.toTurkishFormatDate = function (format) {
  ...
  client.on('ready', ()=>{
    client.channels.cache.get('sese bağlanmak için ses kanalı id').join()
    })
