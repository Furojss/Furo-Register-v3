...
module.exports.execute = async (client, message, args) => {
    ...
    if (!member || !isim || !yaş) return message.channel.send(embed.setDescription(`<a:gzg:829299711965003776> Komutu doğru kullanmalısın. \`Örnek: ${ayar.prefix || '.'}e @üye isim yaş\``)).then(x => x.delete({timeout: 10000}));
    ...
    message.channel.send(embed.setDescription(`<a:gzg:829299711965003776> ${member} adlı üye sunucumuza **erkek** olarak kaydedilmiştir.`))
